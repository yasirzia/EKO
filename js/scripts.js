...
(function($){
	...
	var url = window.location;	   
		  $('ul.menu a').filter(function() { return this.href == url; }).parent().addClass('current-menu-item').closest('ul').parent().addClass('current-menu-item').closest('ul').parent().addClass('current-menu-item');
